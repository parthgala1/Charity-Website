    ...
    return (
        <div id='details' className='h-full my-10 flex flex-col justify-center items-center '>
            <div className='flex flex-col justify-center items-center w-full tex-center'>
                <h1 className='text-3xl md:text-5xl font-semibold font-serif text-gray-900'>Our Helping Hands</h1>
                <h2 className='mt-7 text-md md:text-xl text-center font-serif text-gray-500'>"Behind every success story at Jivam Group are our dedicated and passionate team members."</h2>
            </div>
            <div className='flex flex-wrap justify-center items-center w-full text-center my-10'>
                ...
                ))}
                {
                    authUser && authUser.member === 'Member' && (
                        <div className='md:w-1/5 h-full p-5 flex items-center justify-center'>
